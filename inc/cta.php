<section class="cta">
    <div class="container">
        <h3 class="cta__title">оставьте свои данные и <span> получите подробное
            ком. предложение</span></h3>
        <p class="cta__desc">А также проконсультируем вас, как надежно <span> сохранить свой дом или офис в защите</span></p>
        <form method="post" class="form-cta form">
        ...
        <input type="text" name="easydata" class="easy-breezy">
            <div class="form-cta__top">
                <p>После отправки заявки, к вам на почту или мессенджер
                    <span>придет PDF-документ</span> с ком. предложением</p>
            </div>
        ...
        <img src="<?php bloginfo('template_url')?>/assets/img/cta.png" class="cta__img" alt="">
    </div>
</section>